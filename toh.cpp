...
void boderbox()
{
    ...
    setfillstyle(SOLID_FILL,RED);
    rectangle(625,300,640,470);
    floodfill(626,301,13);
    setfillstyle(SOLID_FILL,RED);
    rectangle(555,470,715,490);
    floodfill(556,471,13);
    //for text
    setcolor(8);
    settextstyle(10, 0, 3);
...
void move(int dn,int from,int to)
{
	if(from==1&&to==3)
	{
		...
		while(box[dn][1]>250)
		{
			...
			box[dn][1]=box[dn][1]-10;
			box[dn][3]=box[dn][3]-10;
			boderbox();
			cb(dn);
			delay(10);
		}
		...
		while(box[dn][0]<(628-((box[dn][2]-box[dn][0])/2)))
		{
			cleardevice();
			rectangle(box[dn][0],box[dn][1],box[dn][2],box[dn][3]);
			box[dn][0]=box[dn][0]+10;
			box[dn][2]=box[dn][2]+10;
			boderbox();
			cb(dn);
			delay(10);	
		}
